        ...
        <div className="py-8">
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="max-w-sm rounded overflow-hidden shadow-2xl ">
                    <img className="w-full" src="/image.png" alt="Moola" />
                ...
                <div className="max-w-sm rounded overflow-hidden shadow-2xl ">
                    <img className="w-full h-40 bg-white" src="/ollama.svg" alt="Moola" />
                    <div className="px-6 py-4">
                    ...
                    <div className="px-6 pt-4 pb-2">
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#AI</span>
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Chatbot</span>
                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2"> <a href="https://github.com/sumituiet/interface_llms">More..</a></span>
                    </div>
                </div>
            </div>
