        ...
        <div className="py-8">
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="max-w-sm rounded overflow-hidden shadow-2xl ">
                    <Image className="w-full" src="/portfolio/image.png" alt="Moola" width={200} height={200} />
                ...
                <div className="max-w-sm rounded overflow-hidden shadow-2xl ">
                    <Image className="w-full h-40 bg-white" src="/portfolio/ollama.svg" alt="Moola" height={200} width={200}/>
                    <div className="px-6 py-4">
